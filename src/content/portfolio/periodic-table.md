...
- I also used TailwindCSS's fairly new, at the time, `group-[]` class and it worked really well. You can find in the example above. I have since used it in various projects.
