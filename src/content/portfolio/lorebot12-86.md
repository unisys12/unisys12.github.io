...
title: Lorebot12-86
tags: ["blog", "javascript", "discord", "destiny", "api"]
...
The most important thing I learned from this project was `structure` and _abstract, just for the sake of abstraction, has not value._

For me to maintain this project, as long as I did, it would not have been possible without a somewhat decent structure. Could it be improved upon? Heck ya! But that should always be the case when you go back to code you wrote 3-5 yrs ago. If not, you haven't grown.
