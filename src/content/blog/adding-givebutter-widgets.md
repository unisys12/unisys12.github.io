...
![Stock image hosted on Cloudinary!](https://res.cloudinary.com/dtm8qhbwk/image/upload/q_auto,g_face,f_auto/v1720813611/blog/stock/greg-rakozy-oMpAz-DN-9I-unsplash_qebiip.webp)
...
You might notice the use of the `id` attribute on the component. This is it's identifier to Givebutter. Each component your create, under your account, is unique and will have a unique id associated with it. And this where things could get tricky! How do you assign the correct id dynamically? Especially since will be dynamically creating 25 or more of them. Why have unique id's you ask?
